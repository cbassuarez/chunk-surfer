...
const WARNINGS = [
  ...
  '',
  'With permission, battle fireballs can cross the game frame into up to four',
  'fixed, click-through game-owned black windows. They never take focus or move',
  'the main game window. Settings can close every fireball surface immediately.',
  '',
...
const PROFILE = [
  ...
  '• Non-blocking battle fireballs that can continue into up to four fixed,',
  '  click-through black windows without moving or focusing the main window.',
  ...
  'Settings can disable any module, close fireball surfaces, reset inference, open the',
