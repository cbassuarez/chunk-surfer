...
export const STORY_TARGET = Object.freeze({
  ...
  vanShut: target('story:yard-van-shut','FINISH PACKING AT THE VAN',STORY_GUIDANCE_ANCHORS.van,{kind:'prop',propId:'yard-van'}),
...
export function resolveStoryGuidanceTarget({
  ...
  if(!prologueDone){
    if(!bagTaken||!kitReady)return STORY_TARGET.van;
