...
export const CONSERVATORY_LIGHTS = Object.freeze([
  ...
  L('dance-stair-failing', LIGHT_KIND.EMERGENCY, 45.0, 19.75, -1.5, [1, .48, .22], .20, 6.0,
    { groups:['basement'], zones:[ZONE.danceStudio, ZONE.stair], anchorPropId:'light-dance-stair-casing', flutter:{ amount:.17, steady:.20 } }),
  L('plant-panel-green', LIGHT_KIND.INDICATOR, 37.55, 30.0, -2.0, [.18, 1, .30], .10, 2.2,
    { groups:['basement'], zones:[ZONE.plant] }),
  L('plant-service-live', LIGHT_KIND.FITTING, 35.0, 29.0, -1.55, [.69, .83, .70], .88, 9.0,
    { groups:['basement'], zones:[ZONE.plant], circuit:'sp01', anchorPropId:'light-plant-service-casing', flutter:{ amount:.06, steady:.84 } }),
  L('dance-work-live', LIGHT_KIND.FITTING, 18.0, 10.0, -1.55, [.78, .78, .65], .82, 9.0,
    { groups:['basement'], zones:[ZONE.danceStudio], circuit:'sp01', anchorPropId:'light-dance-work-casing', flutter:{ amount:.07, steady:.78 } }),
  ...
  L('academic-emergency-east-failing', LIGHT_KIND.EMERGENCY, 93, 23, 11.8, [1, .57, .28], .22, 6.4,
    { groups:['academic'], zones:[ZONE.academic], flutter:{ amount:.16, steady:.22 } }),
  L('foh-live-west', LIGHT_KIND.FITTING, 81.0, 13.0, 3.25, [.74, .82, .78], .92, 10,
    { groups:['ground'], zones:[ZONE.foyer], circuit:'sp03', anchorPropId:'light-foh-west-casing', flutter:{ amount:.06, steady:.88 } }),
  L('foh-live-east', LIGHT_KIND.FITTING, 92.0, 16.5, 3.25, [.74, .82, .78], .88, 10,
    { groups:['ground'], zones:[ZONE.foyer], circuit:'sp03', anchorPropId:'light-foh-east-casing', flutter:{ amount:.05, steady:.84 } }),
  ...
  L('natatorium-end-window-spill', LIGHT_KIND.SKY, 89, 49, 5.4, [.58, .74, .72], 1.18, 16,
    { groups:['ground'], zones:[ZONE.natatorium] }),
  L('pool-service-live-a', LIGHT_KIND.FITTING, 91.0, 43.0, 3.3, [.69, .83, .78], .94, 10,
    { groups:['ground'], zones:[ZONE.natatorium], circuit:'sp02', anchorPropId:'light-pool-service-a-casing', flutter:{ amount:.05, steady:.90 } }),
  L('pool-service-live-b', LIGHT_KIND.FITTING, 77.0, 43.0, 3.3, [.67, .81, .76], .86, 10,
    { groups:['ground'], zones:[ZONE.natatorium], circuit:'sp02', anchorPropId:'light-pool-service-b-casing', flutter:{ amount:.07, steady:.82 } }),

  // Concert hall and the upper floor.
  L('hall-stage-door-maintained', LIGHT_KIND.EMERGENCY, 100.0, 8.0, 2.65, [1, .40, .22], .48, 7.0,
    { groups:['hall'], zones:[ZONE.hall], anchorPropId:'light-hall-stage-door-casing' }),
  L('hall-lounge-live', LIGHT_KIND.FITTING, 101.0, 27.0, 3.1, [.78, .74, .62], .82, 10,
    { groups:['hall'], zones:[ZONE.hall], circuit:'sp03', anchorPropId:'light-hall-lounge-casing', flutter:{ amount:.06, steady:.78 } }),
  L('practice-emergency-north', LIGHT_KIND.EMERGENCY, 60.5, 55.0, 7.3, [1, .52, .25], .42, 7.5,
    { groups:['upper'], zones:[ZONE.practice], anchorPropId:'light-practice-north-casing' }),
  L('practice-emergency-south', LIGHT_KIND.EMERGENCY, 61.0, 81.0, 7.3, [1, .50, .24], .38, 7.5,
    { groups:['upper'], zones:[ZONE.practice], anchorPropId:'light-practice-south-casing' }),
  ...
  L('access-low', LIGHT_KIND.EMERGENCY, 100, 62, 6.65, [1, .68, .38], .72, 5.2,
    { groups:['tower'], zones:[ZONE.bellTower], anchorPropId:'tower-light-lower', anchorOffset:[0,.12,0] }),
  L('access-high', LIGHT_KIND.EMERGENCY, 106, 63, 11.45, [1, .70, .42], .65, 5.0,
    { groups:['tower'], zones:[ZONE.bellTower], anchorPropId:'tower-light-upper', anchorOffset:[0,.12,0] }),
  L('ringing-pendant', LIGHT_KIND.EMERGENCY, 90, 64, 11.55, [1, .72, .46], .58, 7.5,
    { groups:['tower'], zones:[ZONE.bellTower], anchorPropId:'tower-light-ringing', anchorOffset:[0,.12,0] }),
  L('chamber-entry', LIGHT_KIND.EMERGENCY, 97, 64, 15.65, [.92, .80, .61], .54, 5.0,
    { groups:['tower'], zones:[ZONE.bellTower], anchorPropId:'tower-light-entry', anchorOffset:[0,.12,0] }),
  L('louvre-spill', LIGHT_KIND.SKY, 97, 61, 17.4, [.50, .66, .82], 1.22, 8.2,
    { groups:['tower'], zones:[ZONE.bellTower] }),
  L('winch-lamp', LIGHT_KIND.EMERGENCY, 97, 69, 15.25, [1, .74, .43], .74, 5.4,
    { groups:['tower'], zones:[ZONE.bellTower], anchorPropId:'tower-light-winch', anchorOffset:[0,.12,0] }),
  L('service-landing', LIGHT_KIND.EMERGENCY, 106, 70, 11.45, [1, .69, .40], .61, 5.0,
    { groups:['tower'], zones:[ZONE.bellTower], anchorPropId:'tower-light-service', anchorOffset:[0,.12,0] }),
  ...
  L('nave-exit', LIGHT_KIND.EMERGENCY, 100.5, 82, 6.45, [1, .73, .42], .66, 5.8,
    { groups:['tower'], zones:[ZONE.bellTower], phase:'cleared', anchorPropId:'tower-light-organ-exit', anchorOffset:[0,.12,0] }),
]);
