...
const PROFILE_DATA = {
  calm: {
    ...
    material: { localDiffusion: 0.14, detailGain: 0.72, chromaDrift: 0.04, roughnessResponse: 0.05, normalResponse: 0.04 },
  ...
  explore: {
    ...
    material: { localDiffusion: 0.34, detailGain: 1.0, chromaDrift: 0.10, roughnessResponse: 0.11, normalResponse: 0.08 },
  ...
  booth: {
    ...
    material: { localDiffusion: 0.46, detailGain: 1.12, chromaDrift: 0.14, roughnessResponse: 0.15, normalResponse: 0.11 },
  ...
  battle: {
    ...
    material: { localDiffusion: 0.76, detailGain: 1.34, chromaDrift: 0.24, roughnessResponse: 0.22, normalResponse: 0.18 },
  ...
  hush: {
    ...
    material: { localDiffusion: 0.90, detailGain: 0.54, chromaDrift: 0.02, roughnessResponse: 0.18, normalResponse: 0.08 },
  ...
  rupture: {
    ...
    material: { localDiffusion: 1.0, detailGain: 1.48, chromaDrift: 0.32, roughnessResponse: 0.28, normalResponse: 0.22 },
