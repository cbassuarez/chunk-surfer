...
await page.goto(`http://127.0.0.1:5199/index.html?nodisplaynotice=1&nomic=1&sam=0&skiptut=1&nothink=0&pixelMeshSource=world&diffusion=${encodeURIComponent(LENS)}`,
