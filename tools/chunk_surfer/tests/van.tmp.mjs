...
await p.goto('http://127.0.0.1:5173/index.html?nodisplaynotice=1&nomic=1&sam=0&skiptut=1&nothink=1&diffusion='+encodeURIComponent('ws://127.0.0.1:5198'),{waitUntil:'domcontentloaded',timeout:60000});
