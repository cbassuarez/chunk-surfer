...
await page.goto(`${base}/index.html?nodisplaynotice=1&skiptut=1&nomic=1&sam=0&diffusion=${encodeURIComponent('ws://127.0.0.1:5198')}`, { waitUntil: 'domcontentloaded', timeout: 60000 });
