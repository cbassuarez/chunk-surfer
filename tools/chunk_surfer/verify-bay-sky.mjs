...
const output = path.resolve(process.env.OUT || 'artifacts/bay-phase1');
...
await page.goto('http://127.0.0.1:5199/index.html?nodisplaynotice=1&skiptut=1&nomic=1&sam=0&diffusion='
...
const shots = [
  ['bay-01-west-out-of-the-bay.png', 53, 7, -Math.PI / 2, 0.00],
  ['bay-02-west-and-up-at-the-sky.png', 53, 7, -Math.PI / 2, 0.55],
  ['bay-03-straight-up.png', 53, 7, -Math.PI / 2, 1.25],
  ['bay-04-east-at-the-grey-door.png', 53, 7, Math.PI / 2, 0.15],
  ['bay-05-yard-mouth.png', 53, 10, -Math.PI / 2, 0.35],
  // Out in the yard, which is walkable now. Authored yard coords are the yard's
  // logical address: origin (50,200) plus the yard-local cell.
  ['bay-06-at-the-gate-looking-back.png', 78, 207, Math.PI / 2, 0.30],
  ['bay-07-mid-yard-looking-back.png', 88, 207, Math.PI / 2, 0.30],
  ['bay-08-at-the-booth.png', 77, 212, -Math.PI / 2, 0.10],
];
